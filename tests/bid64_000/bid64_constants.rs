...
#[test]
fn _0012() {
  assert_eq!("[F7FB86F26FC0FFFF]", format!("{:?}", d64("-9999999999999999E+369")));
  eq("-9999999999999999E+369", BID64_MIN);
}

#[test]
fn _0013() {
  assert_eq!("[77FB86F26FC0FFFF]", format!("{:?}", d64("+9999999999999999E+369")));
  eq("+9999999999999999E+369", BID64_MAX);
}
